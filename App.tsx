...
import type { CVData, EducationEntry, ExperienceEntry, DrivingLicenseData, ComplementaryTrainingEntry, SkillEntry } from './types';
...
import { generateSummary, extractDataFromCV, improveDescription, generateDescription, generateCoverLetter } from './services/geminiService';
...
import { CoverLetterPromptModal, type CoverLetterPromptData } from './components/CoverLetterPromptModal';
