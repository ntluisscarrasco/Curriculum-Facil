...
import type { CVData, EducationEntry, ExperienceEntry, DrivingLicenseData, ComplementaryTrainingEntry, SkillEntry } from './types.ts';
import { INITIAL_CV_DATA } from './constants.ts';
